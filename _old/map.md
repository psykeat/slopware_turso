...
packages/business/ Domain rules shared by db/app/agents (bulk limits, ledger invariants)
packages/db/       Drizzle ORM schema, migrations, services
packages/registry/ TypeScript-first entity metadata, projections, validation, fixtures
...
- `@repo/business/*` → `packages/business/src/*`
- `@repo/db/*` → `packages/db/src/*`
- `@repo/registry/*` → `packages/registry/src/*`
- `#/` → `apps/web/src/`
...
**Persistence seam:** `packages/db/src/persistence/postgres.ts` backs the current
Postgres compatibility runtime exported by `@repo/db`; `packages/db/src/turso/`
defines the Turso tenant-routing contract for the target adapter.
