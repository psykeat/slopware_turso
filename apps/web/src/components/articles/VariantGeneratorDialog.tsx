...
import { ArrowLeftIcon, ArrowRightIcon, CopyIcon, SaveIcon, SparklesIcon, WandIcon } from "lucide-react";
...
interface PreviewResult {
  articleId: string;
  axes: Array<{ optionId: string; optionName: string; values: Array<{ valueId: string; value: string }> }>;
              ...
              {source === "template" && (
                <div className="flex flex-col gap-3 rounded-md border border-hairline p-4">
                  ...
                  <p className="text-[11px] text-ink-mute">
                    „Anwenden" ergänzt fehlende Achsen/Werte am Artikel (bestehende bleiben
                    erhalten). Die Vorschau nutzt zusätzlich Regeln und SKU-Muster der Vorlage.
                  </p>
                        ...
                        {preview.combinations.length === 0 && (
                          <tr>
                            <td colSpan={4} className="px-3 py-6 text-center text-ink-mute">
                              Keine Kombinationen — erst Achsen und Werte pflegen (oder eine
                              Vorlage anwenden).
                            </td>
                          </tr>
                        )}
          ...
          <div className="flex items-center justify-between border-t border-hairline px-6 py-4">
            ...
            {step === "source" ? (
              <Button
                size="sm"
                disabled={
                  previewMutation.isPending || (source === "template" && !selectedTemplateId)
                }
