DROP INDEX "idx_price_list_item_article";--> statement-breakpoint
...
CREATE INDEX "idx_price_list_item_variant" ON "price_list_item" ("price_list_id","variant_id","valid_from");