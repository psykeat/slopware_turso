...
export function EmailComposer({
  ...
  return (
    ...
    >
      <div className="dark:bg-panelDark no-scrollbar flex min-h-0 flex-1 flex-col overflow-y-auto rounded-2xl">
        {/* To, Cc, Bcc */}
            ...
            {attachments && attachments.length > 0 && (
              <Popover modal={true}>
                <PopoverTrigger asChild>
                  <button
                    className="flex cursor-pointer items-center gap-1.5 rounded-md border border-[#E7E7E7] bg-white/5 px-2 py-1 text-sm hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none dark:border-[#2B2B2B]"
                ...
                >
                  <div className="flex flex-col">
                    <div className="border-b border-[#E7E7E7] p-3 dark:border-[#2B2B2B]">
                      ...
                      <p className="text-xs text-muted-foreground dark:text-[#9B9B9B]">
                    ...
                    <div className="max-h-[250px] flex-1 [scrollbar-width:none] space-y-0.5 overflow-y-auto p-1.5 [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                        ...
                        return (
                          ...
                          >
                            ...
                            <button
                              ...
                              className="ml-1 flex h-6 w-6 shrink-0 cursor-pointer items-center justify-center rounded-full bg-transparent hover:bg-black/5 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
                              aria-label={`Remove ${file.name}`}
                            >
                              <XIcon className="h-3.5 w-3.5 text-muted-foreground hover:text-black dark:text-[#9B9B9B] dark:hover:text-white" />
                            </button>
                          </div>
                        );
                      })}
...
const ContentPreview = ({
  ...
  <motion.div
    ...
    animate="animate"
    exit="exit"
    className="dark:bg-subtleBlack absolute right-0 bottom-full z-30 z-50 w-[400px] overflow-hidden rounded-xl border bg-white p-1 shadow-md"
  >
    <div
